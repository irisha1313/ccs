...
export default {
  ...
  // Color
  brandPrimary: Colors.primaryDark,
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  tabActiveBgColor: Colors.primaryDark,

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: Colors.primaryDark,
  ...
  toolbarDefaultBorder: Colors.primaryDark,
  get statusBarColor() {
  ...
  listNoteSize: 13,
  listItemSelected: Colors.primaryDark,
  ...
  radioSelectedColorAndroid: Colors.primaryDark,
  ...
  // Segment
  segmentBackgroundColor: Colors.primaryDark,
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : Colors.primaryDark,
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : Colors.primaryDark,
  ...
  // Tab
  tabDefaultBg: Colors.primaryDark,
